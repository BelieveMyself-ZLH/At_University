...
import com.zlh.mine.pow.ProofOfWork;
...
/**
 * @Author: ZhouLinHu
 * @Description: 抽象的AioHandler，消息的编解码的通用实现。
 * @Date: Created in 18:13 2019/5/7
 */
public abstract class BaseAioHandler {
     ...
     * @return
     */
    public boolean checkBlock(Block block, IDBAccess dbAccess) {
