package com.zlh.db.impl;

import com.google.common.base.Optional;
import com.zlh.account.Account;
import com.zlh.conf.RocksDbProperties;
...
/**
 * @Author: ZhouLinHu
 * @Description: RocksDB操作方法实现
 * @Date: Created in 14:07 2019/4/13
 */
@Component
public class DBAccessImpl implements IDBAccess {
    static Logger logger = LoggerFactory.getLogger(DBAccessImpl.class);

    private RocksDB rocksDB;
    public static final String BLOCKCHAIN_PREFIX = "blockchain_";
    //区块数据存储hash桶前缀
    public static final String BLOCKS_BUCKET_PREFIX = "block_";
    //钱包数据存储hash桶前缀
...
//    public boolean putBlockChain(List<Block> blockchain){
//        return this.put(BLOCKCHAIN_PREFIX, blockchain);
//    }
//    public List<Block> getBlockChain(){
//        try {
//            List<Block> list= (List<Block>) SerializeUtils.unSerialize(rocksDB.get(BLOCKCHAIN_PREFIX.getBytes()));
//            return list;
//        } catch (RocksDBException e) {
//            e.printStackTrace();
//            return null;
